...
int main(int argc, char *argv[]) {
    ...
    int K = 3; // Número de filas, cambiar a gusto
    int N = 5; // Número de columnas

    int filas_totales = K * size; // Número total de filas en la matriz
    int tam_matriz = filas_totales * N; // Tamaño total de la matriz
